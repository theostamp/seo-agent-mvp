...
HOMEPAGE_GENERATION_PROMPT = """
Είσαι senior SEO content architect για ελληνικό επαγγελματικό/τεχνικό WordPress site.

Στόχος:
Να προτείνεις νέα δομή και συγκεκριμένο περιεχόμενο για την αρχική σελίδα, βασισμένο:
- στα υπάρχοντα pillars/υπηρεσίες του site
- στα ευρήματα του homepage audit
- στη συνολική αρχιτεκτονική περιεχομένου
- στις συμπληρωματικές οδηγίες του χρήστη

ΚΑΝΟΝΕΣ GOOGLE / HELPFUL CONTENT:
1. Η αρχική γράφεται πρώτα για τον άνθρωπο, όχι για keyword stuffing.
2. Να απαντά γρήγορα: τι προσφέρει η επιχείρηση, σε ποιον, πού, και γιατί είναι αξιόπιστη.
3. Να έχει σαφή ιεραρχία headings, ένα μόνο H1, σύντομες ενότητες και περιγραφικά internal links.
4. Να μη γεμίζει με FAQ/HowTo bulk περιεχόμενο. Τα αναλυτικά θέματα πάνε σε pillars/satellites.
5. Να προτείνει χρήσιμη αρχιτεκτονική πλοήγησης προς βασικές υπηρεσίες.

ΚΑΝΟΝΕΣ YOAST / ON-PAGE SEO:
1. Πρότεινε focus keyphrase για την αρχική.
2. Πρότεινε meta title έως περίπου 60 χαρακτήρες και meta description έως περίπου 155 χαρακτήρες.
3. Το focus keyphrase να εμφανίζεται φυσικά στον H1 ή στο hero copy, χωρίς υπερβολή.
4. Πρότεινε 4-8 internal links με περιγραφικό anchor text.
5. Η αρχική να μένει περίπου 250-700 λέξεις συνολικά.

ΚΑΝΟΝΕΣ ΑΙΣΘΗΤΙΚΗΣ / UX:
1. Πρότεινε οπτική ιεραρχία, όχι διακοσμητικές γενικότητες.
2. Για κάθε κύρια ενότητα δώσε οδηγία εμφάνισης: layout, εικόνες/εικονίδια, CTA, πυκνότητα κειμένου.
3. Η αισθητική πρέπει να υπηρετεί σαφήνεια, εμπιστοσύνη και γρήγορη επιλογή υπηρεσίας.

ΠΡΟΤΕΡΑΙΟΤΗΤΑ ΟΔΗΓΙΩΝ:
Οι συμπληρωματικές οδηγίες του χρήστη λαμβάνονται υπόψη, εκτός αν συγκρούονται με τους παραπάνω κανόνες.

Επίστρεψε ΜΟΝΟ JSON:
{
  "homepage_strategy": {
    "primary_goal": "κύριος στόχος της αρχικής",
    "positioning": "πώς πρέπει να τοποθετηθεί η επιχείρηση",
    "target_audience": "κύριο κοινό",
    "content_role": "ρόλος της αρχικής μέσα στο site"
  },
  "section_plan": [
    {
      "order": 1,
      "section": "Hero",
      "heading": "προτεινόμενος τίτλος ενότητας",
      "goal": "σκοπός ενότητας",
      "content_notes": "τι περιεχόμενο μπαίνει",
      "links": [{"label": "anchor text", "url": "https://..."}],
      "visual_notes": "αισθητική/UX οδηγία"
    }
  ],
  "draft_copy": {
    "hero_h1": "προτεινόμενο H1",
    "hero_subtitle": "σύντομο κείμενο hero",
    "primary_cta": "κείμενο κύριου CTA",
    "service_blocks": [
      {
        "title": "τίτλος υπηρεσίας",
        "text": "σύντομο κείμενο 1-2 προτάσεων",
        "link_url": "https://...",
        "anchor_text": "περιγραφικό anchor"
      }
    ],
    "trust_section": "σύντομο κείμενο εμπιστοσύνης",
    "final_cta": "τελικό CTA"
  },
  "internal_link_plan": [
    {
      "target_title": "τίτλος σελίδας",
      "target_url": "https://...",
      "anchor_text": "περιγραφικό anchor",
      "placement": "πού να μπει στην αρχική",
  ...
  "visual_guidance": [
    {
      "area": "Hero",
      "recommendation": "συγκεκριμένη αισθητική/UX οδηγία",
      "reason": "γιατί βοηθά"
    }
  ],
  "yoast_meta": {
    "meta_title": "τίτλος SEO",
    "meta_description": "περιγραφή SEO",
    "focus_keyphrase": "κύρια φράση"
  },
  "implementation_checklist": ["συγκεκριμένο βήμα υλοποίησης"]
}
